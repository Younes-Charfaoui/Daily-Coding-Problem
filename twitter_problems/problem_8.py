...
For example, the following descibes a situation where 0 is friends with 1 and 2, 
...
no student in the group has any friends outside this group. For the example above, 
