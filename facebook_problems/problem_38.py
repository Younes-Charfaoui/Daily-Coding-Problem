...
the secret code of the second. In this version, the code may be any 
...
their location in the secret code. For example, if the secret 
code were 123456, then a guess of 175286 would score two, 
