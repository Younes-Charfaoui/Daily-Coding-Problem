...
any drink among this set. For example, in the following situation, customer 0 will 
...
drink recipes he must memorize. Given a dictionary input such as the one above, 
